...
(use-package hjkl
  :straight (hjkl :host github
                    :repo "sam217pa/emacs-hjkl"))
...
(defun run-auto-start ()
  ...
  (when (memq 'exwm-manage--add-frame after-make-frame-functions)
	(esm/start-process-once "ibus" "/bin/ibus-daemon")
	(esm/start-process-once "pnmixer" "/bin/pnmixer")
	(esm/start-process-once "nm-applet" "/bin/nm-applet")))
