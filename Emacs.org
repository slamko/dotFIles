...
#+begin_src emacs-lisp
  ...
  (load-file "~/.emacs.d/bon-app-launcher/bon-app-launcher.el")
...
(defun run-auto-start ()
  (start-process-shell-command "killall nm-applet")
  (start-process-shell-command "killall pnmixer")
  (start-porcess-shell-command "nm-applet &")
  (start-porcess-shell-command "pnmixer &")
  (start-process-shell-command "pulseaudio --start --log-target=syslog"))
...
(exwm-input-set-key (kbd "s-q") 'save-buffer-kill-terminal)
